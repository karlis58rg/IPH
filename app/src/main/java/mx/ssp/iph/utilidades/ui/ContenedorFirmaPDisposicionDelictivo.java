...
public class ContenedorFirmaPDisposicionDelictivo extends DialogFragment {
    ...
    public ContenedorFirmaPDisposicionDelictivo(Integer idlblFirma, Integer idlblFirmaBase64, Integer IdimgFirmaMiniatura) {
        ...
        btnGuardar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (Base64Blank.equals(encoded.replaceAll("\n", "")))
                {
                    ...
                    imgFirmaMiniatura = (ImageView) getActivity().findViewById(R.id.imgFirmaAutoridadRealizadaDelictivoMiniatura);
